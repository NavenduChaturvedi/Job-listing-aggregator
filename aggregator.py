...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("-l", "--location", help='filter: location substring (e.g. "remote", "europe")')
    parser.add_argument(
        "--source",
        action="append",
    ...
    parser.add_argument("--max-age-days", type=int, dest="max_age_days", help="drop listings older than N days")
    ...
    parser.add_argument("--print", dest="print_table", action="store_true", help="also print the listings")
